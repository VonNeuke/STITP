...
fnum=size(name,2);
set(handles.edit9,'max',fnum);
for i=1:fnum
    Load_data(i) = load(cell2mat(strcat(path,name(i))));
    set(handles.edit9,'value',i);
    temp(i)=strcat(path,name(i));
...
% Img_data_pro
Img_data_pro = load([path,name(1:strfind(name,'.')-1),'_pro']);
